...
if ($_SESSION['page'] === 'home2') {
    $toggle_active_home2 = $toggle_active;
    $toggle_active_profileAdmin2 = '';
    $toggle_active_MengaturTaksi = '';
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="home2.php">Dashboard</a>
                    </div>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <h5 class="card-category">Penambahan Taxi</h5>
                                <h4 class="card-title">Tahun 2024</h4>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">Mengatur Ketersediaan Taxi?</td>
                                                <td class="td-actions text-right">
                                                    <button type="button" rel="tooltip" title=""
                                                        class="btn btn-info btn-round btn-icon btn-icon-mini btn-neutral"
