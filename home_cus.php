...
<body class="">
    ...
    -->
            ...
            <div class="sidebar-wrapper" id="sidebar-wrapper">
                <ul class="nav">
                    <li class="active " <?php echo $toggle_active_dashboard; ?>>
                        <a href="home_cus.php">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="home_cus.php">Dashboard</a>
                    </div>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <h5 class="card-category">Pengeluaran Tahun ini</h5>
                                <h4 class="card-title">Pengeluaran dalam rupiah</h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <h5 class="card-category">Penggunaan diskon</h5>
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="now-ui-icons loader_refresh spin"></i> Last 7 days
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card  card-tasks">
                            <div class="card-header ">
                                <h5 class="card-category">Diskon</h5>
                                <h4 class="card-title">Diskon yang tersedia hari ini</h4>
                            </div>
                            <div class="card-body ">
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-left">Diskon 10.000 Rupiah pada setiap 10 kali
                                                    perjalanan"</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">Diskon hingga 10% ongkos perjalanan selama dua
                                                    hari</td>
                                                <td class="td-actions text-right">
                                                    <button type="button" rel="tooltip" title=""
                                                        class="btn btn-info btn-round btn-icon btn-icon-mini btn-neutral"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">Diskon 50% pada perjalanan setiap melakukan
