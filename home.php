...
<body class="">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <h5 class="card-category">Penambahan Pengguna</h5>
                                <h4 class="card-title">Tahun 2024</h4>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">Mengecek Pengguna Baru?</td>
                                                <td class="td-actions text-right">
                                                    <button type="button" rel="tooltip" title=""
                                                        class="btn btn-info btn-round btn-icon btn-icon-mini btn-neutral"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Tambahkan event listener pada tombol "plus"
            document.getElementById('plusButton1').addEventListener('click', function () {
                handleCheckboxClick('taskCheckbox1');
            });
            document.getElementById('plusButton2').addEventListener('click', function () {
                handleCheckboxClick('taskCheckbox2');
            });
        });
        ...
        function handleCheckboxClick(checkboxId) {
            ...
            if (checkbox.checked) {
                // Tambahkan script PHP di sini
                var script = document.createElement('script');
                script.innerHTML = "<?php echo '<script>alert(\"Terima Kasih!\"); window.location.href=\"home.php\";</script>'; ?>";
