...
// $registrasi_customer = $result->fetch_assoc();
...
if ($_SESSION['page'] === 'home4') {
    ...
    $toggle_active_home4 = '';
    $toggle_active_profileAdmin4 = $toggle_active;
    $toggle_active_feedback = '';
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="profileAdmin4.php">Admin Profile</a>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-xs btn-warning" name="btn_ubah" data-toggle="modal"
                                    data-target="#Ubahprofile4Modal">Ubah</button>
                                <!-- Modal ubah -->
                                <div class="modal fade" id="Ubahprofile4Modal" tabindex="-1" role="dialog"
                                    aria-labelledby="Ubahprofile4ModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 class="modal-title" id="Ubahprofile4ModalLabel"
                                            ...
                                            <form id="formprofile4Artikel" method="post" action="Ubah_profile4.php"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="profile4">Email Anda</label>
                                                        <input type="text" class="form-control" id="email" name="email"
                                                            placeholder="<?php echo $data_email; ?>" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="profile4">Nomor Anda</label>
                                                        <input type="text" class="form-control" id="number"
                                                            name="number"
                                                            placeholder="<?php echo $data_nomor; ?>" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="profile4">Kota Asal Anda</label>
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <div class="author">
                                    <a href="profileAdmin4.php">
                                        <img class="avatar border-gray" src="img/Mine.jpg" alt="...">
