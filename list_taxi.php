...
// Query untuk mendapatkan daftar taksi
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($plat_nomor && $merk && $model) {
        ...
        if (mysqli_query($koneksi, $sql)) {
            echo "Taksi berhasil ditambahkan! <a href='list_taxi.php'>Kembali ke List Taksi</a>";
        } else {
...
if ($_SESSION['page'] === 'home3') {
    ...
    $toggle_active_profileAdmin3 = '';
    $toggle_active_ManagementTaksi = '';
    $toggle_active_ListTaxi = $toggle_active;
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="profileAdmin.php">Admin List Taxi</a>
                    </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($daftar_taksi as $taksi): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $taksi['status']; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                            </div>
                            <a href="add_taxi.php" class="btn btn-primary" style="align-items: center;">Tambah Taksi</a>
                        </div>
                    </div>
                </div>
            </div>
